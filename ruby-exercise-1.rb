...
puts "The first line has #{lines.first.split.count} words in it"

first_stanza_lines = lines[0..8]

first_stanza = "#{first_stanza_lines}"

puts "The first stanza has #{first_stanza.split.count} words in it"

puts "Here is the poem with its lines randomly rearranged ..."

# Answer for the last line: puts "#{lines.sample(120)}"
